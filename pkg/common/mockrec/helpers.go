...
func RecordCall(ctrl *gomock.Controller, receiver any, methodName string, methodType reflect.Type, args ...any) *gomock.Call {
	ctrl.T.Helper()
...
func RecordNoArgsCall(ctrl *gomock.Controller, receiver any, methodName string, methodType reflect.Type) *gomock.Call {
	ctrl.T.Helper()

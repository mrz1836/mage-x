...
All examples and tests run via GitHub Actions using Go 1.26+. View the [examples directory](examples) for complete project demonstrations.
...
> Benchmarks run on Apple M1 Pro (ARM64) with Go 1.26+
